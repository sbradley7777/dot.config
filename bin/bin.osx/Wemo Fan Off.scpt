...
# Description: This script turns off a WeMo device for a specific device and
# logs to a file.
#
...
log_event("Turning off the WeMo for Bonus Room Fan.")

do shell script "/usr/local/bin/wemo -f switch fan off"
