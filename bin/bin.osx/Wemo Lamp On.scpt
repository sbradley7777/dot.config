...
# Description: This script turns on a WeMo device on a specific device and
# logs to a file.
#
...
log_event("Turning on the WeMo for Bonus Room Desk Lamp.")

do shell script "/usr/local/bin/wemo -f switch lamp on"
