...
if __name__ == "__main__":
    try:
        # These would go in some global file that all your files source in. For
        # me they all source in the lib "sx"
        MAIN_LOGGER_NAME = "someawesomelogger"
        # #######################################################################
        ...
        lwObjSXC = LogWriter(sx.MAIN_LOGGER_NAME,
                             ...
                             disableConsoleLog=False)
        """
        lwObjSXC = LogWriter(MAIN_LOGGER_NAME,
                             logging.INFO,
                             "%(levelname)s %(message)s",
                             disableConsoleLog=False)


        message = "TEST MESSAGE WITH CONSOLE HIGHLIGHT"
        logging.getLogger(MAIN_LOGGER_NAME).status(message)
        logging.getLogger(MAIN_LOGGER_NAME).warn(message)
        logging.getLogger(MAIN_LOGGER_NAME).error(message)
        logging.getLogger(MAIN_LOGGER_NAME).debug(message)
        logging.getLogger(MAIN_LOGGER_NAME).info(message)

        print "Just a logger test."
