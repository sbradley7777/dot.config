...
# Description: This script turns on a WeMo device for a specific device and
# logs to a file.
#
...
log_event("Turning on the WeMo for Bonus Room Fan.")

do shell script "/usr/local/bin/wemo -f switch fan on"
